...
/*
oops.Encapsulation says 2 things:
...
public class Encapsulation {
    public static void main(String[] args) {
        ...
        // System.out.println("Current Speed of My Sports oops.Car is set to " + mySportsCar.currentSpeed);

        System.out.println("Current Speed of My Sports oops.Car is " + mySportCar.getSpeed());
    }
}
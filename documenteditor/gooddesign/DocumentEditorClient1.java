...
interface DocumentElement1 {
    public abstract String render();
}

// Concrete implementation for text elements
class TextElement implements DocumentElement1 {
    private String text;
...
class ImageElement implements DocumentElement1 {
...
class NewLineElement implements DocumentElement1 {
    @Override
    public String render() {
        return "\n";
    }
...
class TabSpaceElement implements DocumentElement1 {
    @Override
    public String render() {
        return "\t";
    }
...
class Document {
    private List<DocumentElement1> documentElements = new ArrayList<>();

    public void addElement(DocumentElement1 element) {
    ...
    public String render() {
        ...
        for (DocumentElement1 element : documentElements) {
...
class DocumentEditor1 {
    ...
    public DocumentEditor1(Document document, Persistence storage) {

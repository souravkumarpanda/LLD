...
class ManualsCar extends MyCar {
    private int currentGear;

    public ManualsCar(String brand, String model) {
        super(brand, model);
        this.currentGear = 0;
    }
...
class ElectricsCar extends MyCar {
    private int batteryLevel;

    public ElectricsCar(String brand, String model) {
        super(brand, model);
...
public class DynamicPolymorphism {
    public static void main(String[] args) {
        MyCar myManualCar = new ManualsCar("Suzuki", "WagonR");
        ...
        MyCar myElectricCar = new ElectricsCar("Tesla", "Model S");
